...
El uso de vectores simplifica la implementación del algoritmo y la ordenación garantiza que las distancias se calculen correctamente

No se consideraron más soluciones debido a la simplicidad de las operaciones requeridas.
