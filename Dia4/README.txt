...
La alternativa inicial fue explirar las celdas de manera recursiva, pero dado el volumen de el input del problema cambiamos a realizarlo con grafos ya que es mejor para explorar correctamente todas las direcciones posibles.
